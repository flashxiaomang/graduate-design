    ...
    def parse_note(self, note):
        ...
        for elem in note:
            ...
            if self.isPiano:
                ...
                if elem.tag == 'unpitched':
                    for e in elem:
                        if e.tag == 'display-step':         # Pitch
                            unpitched = e.text
                        # elif e.tag == 'alter':      # Not used
                        #     pass
                        elif e.tag == 'display-octave':     # Octave number
                            display_octave = e.text
                    # Create
                    sequence[staff] += 'note-' + unpitched + display_octave
